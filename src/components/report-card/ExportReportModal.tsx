...
import ReportPrintModal from './print/ReportPrintModal';
...
export default function ExportReportModal({
  ...
  const handleExport = async () => {
    try {
      ...
      const response = await fetch('/api/report-card/data', {
        method: 'POST',
      ...
      onClose(); // Close this selection modal
    } catch (error) {
    ...
    <>
      <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
        ...
        <DialogActions>
          ...
          >
            {isExporting ? 'Preparing Preview...' : 'Generate High-Fidelity Preview'}
          </Button>
        </DialogActions>
      </Dialog>

      {
        reportData && (
          <ReportPrintModal
            ...
            sections={exportOptions.sections as any}
          />
        )
      }
    </>
