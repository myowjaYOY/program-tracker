-- ============================================================================
-- Fix Schedule Role Propagation
-- Date: 2025-10-27
-- Description: Update generate_member_program_schedule to copy program_role_id
--              from member_program_items and member_program_item_tasks to the
--              schedule tables
-- ============================================================================
...
SELECT 'Schedule role propagation fix applied successfully' as status;
