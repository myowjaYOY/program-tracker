...
-- ========================================================================================================
-- Purpose: Restore generate_member_program_schedule function to original state
-- Date: 2025-11-20
-- Use Case: Emergency rollback if new implementation causes issues
-- ========================================================================================================
...
-- 5. Test with a known program: SELECT generate_member_program_schedule(program_id);
...
BEGIN
  ...
  -- NOTE: This is the ORIGINAL buggy logic that deletes both NULL and FALSE
...
SELECT 
  'SUCCESS: generate_member_program_schedule function has been restored to original state.' as status,
...
-- Test with a known program (replace XXXXX with actual program_id)
-- SELECT generate_member_program_schedule(XXXXX);

-- Check schedule item counts
SELECT 
  'Schedule items summary after rollback:' as info,
